        ...
        <div className="fixed inset-0 bg-[#0a0a0a] text-white flex flex-col font-sans select-none overflow-hidden touch-none p-6">
            ...
            <header className="flex items-center justify-between mb-8 px-4">
                ...
                <div className="flex gap-4">
                    <button className="flex items-center gap-3 px-6 py-3 bg-[#c2410c]/20 border border-[#c2410c]/40 rounded-2xl text-[10px] font-black italic uppercase tracking-widest text-[#fb923c] hover:bg-[#c2410c]/30 transition-all">
