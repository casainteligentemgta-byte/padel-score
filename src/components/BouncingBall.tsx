...
/**
 * BouncingBall — Pelota de pádel animada con efecto de rebote physics-style.
 * Incluye:
 *  • sombra que se achica al subir y agranda al bajar (elipse dinámica)
 *  • squash en el punto más bajo (deformación realista)
 *  • brillo interior que rota
 *  Reutilizable: <BouncingBall size={40} />
 */
