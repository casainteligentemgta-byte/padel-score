        ...
        <tbody>
          {rows.map((r) => (
            <tr key={r.id} className="border-t border-white/10">
              <td className="px-2 py-1 text-[11px] text-white/90 truncate max-w-[140px]">
              ...
              <td className="px-2 py-1 text-right">
                <button onClick={() => onRemove(r.id)} className="p-1 rounded bg-red-500/10 text-red-400">
                  <X size={12} />
                </button>
              </td>
            </tr>
          ...
          {rows.length === 0 && (
            <tr>
              <td className="px-2 py-3 text-[11px] text-white/40 text-center" colSpan={4}>
                Sin medios asignados
              </td>
            </tr>
          )}
        </tbody>
