...
6. **Pantallas del club (boards):** en /admin/boards se gestionan las pantallas/boards; en /display/tv o rutas similares se muestran marcadores, publicidad y tira informativa para TVs en las instalaciones.
